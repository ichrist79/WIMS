        ...
        <div class="row">
            <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
                <form role="form" method="post" action="signup.php">
                    <h2>Παρακαλώ κάντε την εγγραφή <small>πριν συνεχίσετε.</small></h2>
                    <hr class="colorgraph">
                    <div class="row">
                        <div class="col-xs-12 col-sm-6 col-md-6">
                            <div class="form-group">
                                <input type="text" name="first_name" id="first_name" class="form-control input-lg" placeholder="Όνομα" tabindex="1">
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-6">
                            <div class="form-group">
                                <input type="text" name="last_name" id="last_name" class="form-control input-lg" placeholder="Επώνυμο" tabindex="2">
                            </div>
                        </div>
                    </div>

                    <div class="form-group">
                        <input type="text" name="display_name" id="display_name" class="form-control input-lg" placeholder="Όνομα στην οθόνη" tabindex="3">
                    </div>
                    <div class="form-group">
                        <input type="email" name="email" id="email" class="form-control input-lg" placeholder="Ηλεκτρονική Διεύθυνση" tabindex="4">
                    </div>
                    <div class="row">
                        <div class="col-xs-12 col-sm-6 col-md-6">
                            <div class="form-group">
                                <input type="password" name="password" id="password" class="form-control input-lg" placeholder="Κωδικός" tabindex="5">
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-6">
                            <div class="form-group">
                                <input type="password" name="password_confirmation" id="password_confirmation" class="form-control input-lg" placeholder="Επιβεβαίωση κωδικού" tabindex="6">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-xs-8 col-sm-9 col-md-9">
                            Πατώντας το <strong class="label label-primary">Εγγραφή</strong>, συμφωνείτε με τους <a href="#" data-toggle="modal" data-target="#t_and_c_m">Όρους χρήσης</a> αυτής της ιστοσελίδας, συμπεριλαμβανομένης και της χρήσης Cookies.
                        </div>
                    </div>

                    <hr class="colorgraph">
                    <div class="row">
                        <div class="col-xs-12 col-md-6"><input type="submit" name="register" value="Εγγραφή" class="btn btn-primary btn-block btn-lg" tabindex="7"></div>
                        <div class="col-xs-12 col-md-6"><a href="index.php" class="btn btn-success btn-block btn-lg">Είσοδος</a></div>
                    </div>
                </form>
            </div>
        </div>
...
try {
    if (isset($_POST['register'])) {
        ...
        $passcon = sha1($_POST['password_confirmation']);
        ...
        if ($fname == "" || $lname == "" || $dname == "" || $password == "" || $email == "") {
            ...
            if ($register1 > 0) {
                ...
                $conn->exec("INSERT INTO user (first_name,last_name,password,email,display_name) VALUES ('" . $fname . "','" . $lname . "','" . $password . "','" . $email . "','" . $dname . "')");
